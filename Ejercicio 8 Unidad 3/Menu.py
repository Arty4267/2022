...
#        cuil = input("Ingrese el cuil: ")
    ...
    def opcion1(self, unaColeccionpersonal: IColeccion):
        ...
        posicion = self.__ingresador.inputInt("Ingrese la posicion en la que desea insertar el agente, las posiciones empiezan en 1: ", "La posicion ingresada no es valida, reintente: ")
        while not insertado:
            try:
    ...
    def opcion3(self, unaColeccionPersonas: IColeccion):
        posicion = self.__ingresador.inputInt("Ingrese la posicion del agente que desea mostrar, las posiciones empiezan en 1: ", "La posicion ingresada no es valida, reintente: ")
        mostrado = False
        try:
